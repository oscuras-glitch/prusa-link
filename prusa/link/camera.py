...
from prusa.connect.printer.cameras import ThreadedDriver, Resolution, \
    CapabilityType, ResolutionCapability
...
class V4L2Driver(ThreadedDriver):
    ...
    def __init__(self, camera_id, config, unavailable_cb):
        ...
        try:
            ...
            self._config["resolution"] = ResolutionCapability.to_string(
                highest_resolution)
    ...
    def take_a_photo(self):
        ...
        data = self.stream.read()  # Throw this old data out
